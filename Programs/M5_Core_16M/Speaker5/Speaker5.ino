...
// ★音量：最初から聞こえる値で開始して、短時間でTARGETへ
static constexpr uint8_t  START_VOL   = 120;   // 0だと「途中から」に聞こえる
static constexpr uint8_t  TARGET_VOL  = 200;
static constexpr uint32_t VOL_RAMP_MS = 300;   // 1500だと前半が聞こえにくい
...
void setup() {
  ...
  spk.dma_buf_count = 16;   // 20は起動失敗しやすい
